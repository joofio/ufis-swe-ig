Instance: AMLaurobindo-10mg-Tablet-SE-IS-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#Tablet "200000002152"
* packageFor = Reference(AMLaurobindo-10mg-Tablet-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AMLaurobindo-10mg-Tablet-SE-IS-MID)
