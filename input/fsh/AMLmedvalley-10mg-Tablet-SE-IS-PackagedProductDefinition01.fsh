Instance: AMLmedvalley-10mg-Tablet-SE-IS-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#Tablet "200000002152"
* packageFor = Reference(AMLmedvalley-10mg-Tablet-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AMLmedvalley-10mg-Tablet-SE-IS-MID)
