Instance: AMLvitabalans-10mg-Tablet-SE-IS-PPD02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 30 http://spor.ema.europa.eu/v1/lists/200000000014#Tablet "200000002152"
* packageFor = Reference(AMLvitabalans-10mg-Tablet-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AMLvitabalans-10mg-Tablet-SE-IS-MID)
