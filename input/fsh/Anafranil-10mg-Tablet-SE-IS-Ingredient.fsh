Instance: Anafranil-10mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Anafranil-10mg-Tablet-SE-IS-MPD)
* for[+] = Reference(Anafranil-10mg-Tablet-SE-IS-MID)
* for[+] = Reference(Anafranil-10mg-Tablet-SE-IS-APD)
