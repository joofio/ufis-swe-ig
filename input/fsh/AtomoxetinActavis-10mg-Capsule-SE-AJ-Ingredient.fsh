Instance: AtomoxetinActavis-10mg-Capsule-SE-AJ-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(AtomoxetinActavis-10mg-Capsule-SE-AJ-MPD)
* for[+] = Reference(AtomoxetinActavis-10mg-Capsule-SE-AJ-MID)
* for[+] = Reference(AtomoxetinActavis-10mg-Capsule-SE-AJ-APD)
