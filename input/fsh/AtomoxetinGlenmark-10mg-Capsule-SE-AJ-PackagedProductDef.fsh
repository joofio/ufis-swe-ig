Instance: AtomoxetinGlenmark-10mg-Capsule-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 28 http://spor.ema.europa.eu/v1/lists/200000000014#200000002113 "Capsule"
* packageFor = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-MID)
