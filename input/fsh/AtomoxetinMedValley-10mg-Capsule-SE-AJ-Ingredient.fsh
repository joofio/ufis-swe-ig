Instance: AtomoxetinMedValley-10mg-Capsule-SE-AJ-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(AtomoxetinMedValley-10mg-Capsule-SE-AJ-MPD)
* for[+] = Reference(AtomoxetinMedValley-10mg-Capsule-SE-AJ-MID)
* for[+] = Reference(AtomoxetinMedValley-10mg-Capsule-SE-AJ-APD)
