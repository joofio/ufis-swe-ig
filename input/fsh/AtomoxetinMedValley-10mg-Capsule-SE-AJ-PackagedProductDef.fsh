...
* packageFor = Reference(AtomoxetinMedValley-10mg-Capsule-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AtomoxetinMedValley-10mg-Capsule-SE-AJ-MID)
