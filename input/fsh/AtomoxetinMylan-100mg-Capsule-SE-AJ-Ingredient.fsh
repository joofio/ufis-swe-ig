Instance: AtomoxetinMylan-100mg-Capsule-SE-AJ-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(AtomoxetinMylan-100mg-Capsule-SE-AJ-MPD)
* for[+] = Reference(AtomoxetinMylan-100mg-Capsule-SE-AJ-MID)
* for[+] = Reference(AtomoxetinMylan-100mg-Capsule-SE-AJ-APD)
