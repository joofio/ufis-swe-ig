Instance: AtomoxetinMylan-10mg-Capsule-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 28 http://spor.ema.europa.eu/v1/lists/200000000014#200000002113 "Capsule"
* packageFor = Reference(AtomoxetinMylan-10mg-Capsule-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(AtomoxetinMylan-10mg-Capsule-SE-AJ-MID)
