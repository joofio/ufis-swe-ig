Instance: BuprenorSTADA-5perh-Transderm-SE-BS-PPD-02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 4 http://spor.ema.europa.eu/v1/lists/200000000014#200000002134 "Patch"
* packageFor = Reference(BuprenorSTADA-5perh-Transderm-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(BuprenorSTADA-5perh-Transderm-SE-BS-MID)
