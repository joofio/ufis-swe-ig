Instance: CMImylan-10mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(CMImylan-10mg-Tablet-SE-IS-MPD)
* for[+] = Reference(CMImylan-10mg-Tablet-SE-IS-MID)
* for[+] = Reference(CMImylan-10mg-Tablet-SE-IS-APD)
