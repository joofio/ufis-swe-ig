...
* packageFor = Reference(CefuroximMIP-1500mg-Powder-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(CefuroximMIP-1500mg-Powder-SE-IS-MID)
