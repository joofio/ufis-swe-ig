Instance: CiklosporinIVAX25mgkapselmjuk-SE-PLC-MPD-BBDL
InstanceOf: Bundle
Usage: #example
* type = #collection
* entry[+].resource = CiklosporinIVAX25mgkapselmjuk-SE-PLC-MPD
...
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/PackagedProductDefinition/CiklosporinIVAX25mgkapselmjuk-SE-PLC-PPD"
* entry[+].resource = CiklosporinIVAX25mgkapselmjuk-SE-PLC-MID


* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/ManufacturedItemDefinition/CiklosporinIVAX25mgkapselmjuk-SE-PLC-MID"
* entry[+].resource = CiklosporinIVAX25mgkapselmjuk-SE-PLC-ING
