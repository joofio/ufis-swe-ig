Instance: DZPorifarm-5mg-Solution-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(DZPorifarm-5mg-Solution-SE-IS-MPD)
* for[+] = Reference(DZPorifarm-5mg-Solution-SE-IS-MID)
* for[+] = Reference(DZPorifarm-5mg-Solution-SE-IS-APD)
