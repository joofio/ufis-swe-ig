Instance: DZPorifarm-5mg-Solution-SE-IS-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(DZPorifarm-5mg-Solution-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(DZPorifarm-5mg-Solution-SE-IS-MID)
