Instance: DicTratiopharma25mgFilmtablet-SE-PLC-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(DicTratiopharma25mgFilmtablet-SE-PLC-MPD)
* for[+] = Reference(DicTratiopharma25mgFilmtablet-SE-PLC-MID)
* for[+] = Reference(DicTratiopharma25mgFilmtablet-SE-PLC-APD)
