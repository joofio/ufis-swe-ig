Instance: DicTratiopharma25mgFilmtablet-SE-PLC-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(DicTratiopharma25mgFilmtablet-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(DicTratiopharma25mgFilmtablet-SE-PLC-MID)
