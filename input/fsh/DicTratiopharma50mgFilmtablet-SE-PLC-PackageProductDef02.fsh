Instance: DicTratiopharma50mgFilmtablet-SE-PLC-PPD02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 50 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(DicTratiopharma50mgFilmtablet-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(DicTratiopharma50mgFilmtablet-SE-PLC-MID)
