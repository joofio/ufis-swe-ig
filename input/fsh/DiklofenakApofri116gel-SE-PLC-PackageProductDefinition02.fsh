Instance: DiklofenakApofri116gel-SE-PLC-PPDinition02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002156 "Tube"
* packageFor = Reference(DiklofenakApofri116gel-SE-PLC-MPD)
...
* packaging.containedItem.item.reference = Reference(DiklofenakApofri116gel-SE-PLC-MID)
