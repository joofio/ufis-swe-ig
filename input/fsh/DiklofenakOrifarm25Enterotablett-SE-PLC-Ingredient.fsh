...
* status = #active
* for[0] = Reference(DiklofenakOrifarm25Enterotablett-SE-PLC-MPD)
* for[+] = Reference(DiklofenakOrifarm25Enterotablett-SE-PLC-MID)
* for[+] = Reference(DiklofenakOrifarm25Enterotablett-SE-PLC-APD)
