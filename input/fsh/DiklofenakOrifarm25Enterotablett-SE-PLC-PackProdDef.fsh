Instance: DiklofenakOrifarm25Enterotablett-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(DiklofenakOrifarm25Enterotablett-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(DiklofenakOrifarm25Enterotablett-SE-PLC-MID)
