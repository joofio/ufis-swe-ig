Instance: DiklofenakOrifarm50Enterotablett-SE-PLC-PPD04
...
* packaging.packaging.containedItem.item.reference = Reference(DiklofenakOrifarm50Enterotablett-SE-PLC-MID)
