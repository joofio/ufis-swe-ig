Instance: DiklofenakTeva116mgggel-SE-PLC-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002156 "Tube"
* packageFor = Reference(DiklofenakTeva116mgggel-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(DiklofenakTeva116mgggel-SE-PLC-MID)
