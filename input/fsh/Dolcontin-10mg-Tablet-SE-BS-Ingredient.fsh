Instance: Dolcontin-10mg-Tablet-SE-BS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Dolcontin-10mg-Tablet-SE-BS-MPD)
* for[+] = Reference(Dolcontin-10mg-Tablet-SE-BS-MID)
* for[+] = Reference(Dolcontin-10mg-Tablet-SE-BS-APD)
