Instance: EnalaprilSandoz-5mg-Tablet-SE-AJ-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "tablet"
* packageFor = Reference(EnalaprilSandoz-5mg-Tablet-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(EnalaprilSandoz-5mg-Tablet-SE-AJ-MID)
