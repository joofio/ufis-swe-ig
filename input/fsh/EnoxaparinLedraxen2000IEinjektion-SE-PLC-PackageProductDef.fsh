Instance: EnoxaparinLedraxen2000IEinjektion-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002150 "Syringe"
* packageFor = Reference(EnoxaparinLedraxen2000IEinjektion-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(EnoxaparinLedraxen2000IEinjektion-SE-PLC-MID)
