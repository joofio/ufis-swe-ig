Instance: Fragmin-10000IE-Solution-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Fragmin-10000IE-Solution-SE-IS-MPD)
* for[+] = Reference(Fragmin-10000IE-Solution-SE-IS-MID)
* for[+] = Reference(Fragmin-10000IE-Solution-SE-IS-APD)
