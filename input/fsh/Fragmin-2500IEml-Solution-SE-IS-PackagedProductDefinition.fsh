Instance: Fragmin-2500IEml-Solution-SE-IS-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002158 "Vial"
* packageFor = Reference(Fragmin-2500IEml-Solution-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Fragmin-2500IEml-Solution-SE-IS-MID)
