Instance: Fragmink-25000IE-Solution-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Fragmink-25000IE-Solution-SE-IS-MPD)
* for[+] = Reference(ManufacturedItemDefinition/Fragmink-25000IE-Solution-SE-IS-MID)
* for[+] = Reference(Fragmink-25000IE-Solution-SE-IS-APD)
