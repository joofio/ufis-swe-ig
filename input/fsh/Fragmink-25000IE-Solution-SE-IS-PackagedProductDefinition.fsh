...
* packageFor = Reference(Fragmink-25000IE-Solution-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference.reference = "Fragmink-25000IE-Solution-SE-IS-MID"
