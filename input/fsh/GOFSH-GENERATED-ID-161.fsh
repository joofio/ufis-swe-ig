Instance: GOFSH-GENERATED-ID-161
InstanceOf: Bundle
Usage: #example
* type = #transaction
* entry[0].resource = Nitrolingual04mgdossublingualspray-SE-PLC-MPD

* entry[=].fullUrl = "MedicinalProductDefinition/Nitrolingual04mgdossublingualspray-SE-PLC-MPD"
...
* entry[=].fullUrl = "Ingredient/Nitrolingual04mgdossublingualspray-SE-PLC-Ingredient"