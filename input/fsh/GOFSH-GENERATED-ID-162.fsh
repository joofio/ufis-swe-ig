Instance: GOFSH-GENERATED-ID-162
InstanceOf: Bundle
Usage: #example
* type = #transaction
...
* entry[+].resource = Nobligan100mgmloraladropparlos-SE-PLC-AdminProductDef

* entry[=].fullUrl = "AdministrableProductDefinition/Nobligan100mgmloraladropparlos-SE-PLC-AdminProductDef"
