Instance: GOFSH-GENERATED-ID-59
InstanceOf: Bundle
Usage: #example
* type = #transaction
...
* entry[+].resource = Dicuno50mgFilmtablet-SE-PLC-AdminProductDef

* entry[=].fullUrl = "AdministrableProductDefinition/Dicuno50mgFilmtablet-SE-PLC-AdminProductDef"
* entry[+].resource = Dicuno50mgFilmtablet-SE-PLC-PackageProductDef01

* entry[=].fullUrl = "PackagedProductDefinition/Dicuno50mgFilmtablet-SE-PLC-PackageProductDef01"
