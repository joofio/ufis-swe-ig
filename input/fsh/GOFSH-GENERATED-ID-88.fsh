Instance: GOFSH-GENERATED-ID-88
InstanceOf: Bundle
Usage: #example
* type = #transaction
* entry[0].resource = Glytrin04mgdossublingualspray-SE-PLC-MPD

* entry[=].fullUrl = "MedicinalProductDefinition/Glytrin04mgdossublingualspray-SE-PLC-MPD"
...
* entry[+].resource = Glytrin04mgdossublingualspray-SE-PLC-Ingredient

* entry[=].fullUrl = "Ingredient/Glytrin04mgdossublingualspray-SE-PLC-Ingredient"