...
* packageFor = Reference(Glytrin04mgdossublingualspray-SE-PLC-MPD)
...
* packaging.containedItem.item.reference = Reference(ProductnameStrengthPharmaceuticaldoseform-SE-PLC-MID)
