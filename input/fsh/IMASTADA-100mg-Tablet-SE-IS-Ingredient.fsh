Instance: IMASTADA-100mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(IMASTADA-100mg-Tablet-SE-IS-MPD)
* for[+] = Reference(IMASTADA-100mg-Tablet-SE-IS-MID)
* for[+] = Reference(IMASTADA-100mg-Tablet-SE-IS-APD)
