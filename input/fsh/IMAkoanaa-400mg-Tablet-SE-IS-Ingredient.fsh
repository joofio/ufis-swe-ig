Instance: IMAkoanaa-400mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(IMAkoanaa-400mg-Tablet-SE-IS-MPD)
* for[+] = Reference(IMAkoanaa-400mg-Tablet-SE-IS-MID)
* for[+] = Reference(IMAkoanaa-400mg-Tablet-SE-IS-APD)
