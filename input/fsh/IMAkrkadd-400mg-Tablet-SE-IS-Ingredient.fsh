Instance: IMAkrkadd-400mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(IMAkrkadd-400mg-Tablet-SE-IS-MPD)
* for[+] = Reference(IMAkrkadd-400mg-Tablet-SE-IS-MID)
* for[+] = Reference(IMAkrkadd-400mg-Tablet-SE-IS-APD)
