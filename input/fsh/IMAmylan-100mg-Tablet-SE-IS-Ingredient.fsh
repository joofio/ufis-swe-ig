Instance: IMAmylan-100mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(IMAmylan-100mg-Tablet-SE-IS-MPD)
* for[+] = Reference(IMAmylan-100mg-Tablet-SE-IS-MID)
* for[+] = Reference(IMAmylan-100mg-Tablet-SE-IS-APD)
