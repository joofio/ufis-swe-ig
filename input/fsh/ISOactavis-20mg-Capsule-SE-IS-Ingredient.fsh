Instance: ISOactavis-20mg-Capsule-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(ISOactavis-20mg-Capsule-SE-IS-MPD)
* for[+] = Reference(ISOactavis-20mg-Capsule-SE-IS-MID)
* for[+] = Reference(ISOactavis-20mg-Capsule-SE-IS-APD)
