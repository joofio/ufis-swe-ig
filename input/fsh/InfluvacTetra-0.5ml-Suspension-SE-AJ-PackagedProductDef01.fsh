Instance: InfluvacTetra-0.5ml-Suspension-SE-AJ-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002150 "Syringe"
* packageFor = Reference(InfluvacTetra-0.5ml-Suspension-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(InfluvacTetra-0.5ml-Suspension-SE-AJ-MID)
