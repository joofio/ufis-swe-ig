Instance: Lido4-Fluor25-EyeDropsSol-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 20 http://spor.ema.europa.eu/v1/lists/200000000014#200000002116 "Container"
* packageFor = Reference(Lido4-Fluor25-EyeDropsSol-SE-AJ-MPD)
...
* packaging.packaging.packaging.containedItem.item.reference = Reference(Lido4-Fluor25-EyeDropsSol-SE-AJ-MID)
