Instance: LidokainAgu-10mgml-InjSol-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002150 "Syringe"
* packageFor = Reference(LidokainAgu-10mgml-InjSol-SE-AJ-MPD)
...
* packaging.packaging.packaging.containedItem.item.reference = Reference(LidokainAgu-10mgml-InjSol-SE-AJ-MID)
