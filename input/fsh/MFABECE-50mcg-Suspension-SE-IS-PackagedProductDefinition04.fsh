Instance: MFABECE-50mcg-Suspension-SE-IS-PPD04
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002111 "Bottle"
* packageFor = Reference(MFABECE-50mcg-Suspension-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MFABECE-50mcg-Suspension-SE-IS-MID)
