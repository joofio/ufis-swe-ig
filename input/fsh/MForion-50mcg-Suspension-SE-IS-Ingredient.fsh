Instance: MForion-50mcg-Suspension-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(MForion-50mcg-Suspension-SE-IS-MPD)
* for[+] = Reference(MForion-50mcg-Suspension-SE-IS-MID)
* for[+] = Reference(MForion-50mcg-Suspension-SE-IS-APD)
