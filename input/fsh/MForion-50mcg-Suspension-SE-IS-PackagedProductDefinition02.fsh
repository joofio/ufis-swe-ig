Instance: MForion-50mcg-Suspension-SE-IS-PPD02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 3 http://spor.ema.europa.eu/v1/lists/200000000014#200000002111 "Bottle"
* packageFor = Reference(MForion-50mcg-Suspension-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MForion-50mcg-Suspension-SE-IS-MID)
