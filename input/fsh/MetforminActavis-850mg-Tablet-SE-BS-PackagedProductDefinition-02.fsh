Instance: MetforminActavis-850mg-Tablet-SE-BS-PPD-02
...
* packageFor = Reference(MetforminActavis-850mg-Tablet-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MetforminActavis-850mg-Tablet-SE-BS-MID)
