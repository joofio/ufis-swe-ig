Instance: MetforminAuro-500mg-Tablet-SE-BS-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(MetforminAuro-500mg-Tablet-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MetforminAuro-500mg-Tablet-SE-BS-MID)
