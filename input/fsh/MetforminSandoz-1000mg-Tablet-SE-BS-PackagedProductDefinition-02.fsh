Instance: MetforminSandoz-1000mg-Tablet-SE-BS-PPD-02
...
* packageFor = Reference(MetforminSandoz-1000mg-Tablet-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MetforminSandoz-1000mg-Tablet-SE-BS-MID)
