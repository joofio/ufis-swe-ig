Instance: MetforminSandoz-500mg-Tablet-SE-BS-PPD-03
...
* packageFor = Reference(MetforminSandoz-500mg-Tablet-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MetforminSandoz-500mg-Tablet-SE-BS-MID)
