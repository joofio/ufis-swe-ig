Instance: MetforminSandoz-850mg-Tablet-SE-BS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(MetforminSandoz-850mg-Tablet-SE-BS-MPD)
* for[+] = Reference(MetforminSandoz-850mg-Tablet-SE-BS-MID)
* for[+] = Reference(MetforminSandoz-850mg-Tablet-SE-BS-APD)
