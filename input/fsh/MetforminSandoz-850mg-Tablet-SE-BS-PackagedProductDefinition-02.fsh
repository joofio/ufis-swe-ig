Instance: MetforminSandoz-850mg-Tablet-SE-BS-PPD-02
...
* packageFor = Reference(MetforminSandoz-850mg-Tablet-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MetforminSandoz-850mg-Tablet-SE-BS-MID)
