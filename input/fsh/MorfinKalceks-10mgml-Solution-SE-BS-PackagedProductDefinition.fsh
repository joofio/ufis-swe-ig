Instance: MorfinKalceks-10mgml-Solution-SE-BS-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002164 "Ampoule"
* packageFor = Reference(MorfinKalceks-10mgml-Solution-SE-BS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(MorfinKalceks-10mgml-Solution-SE-BS-MID)
