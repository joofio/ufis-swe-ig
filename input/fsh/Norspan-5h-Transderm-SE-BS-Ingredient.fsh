Instance: Norspan-5h-Transderm-SE-BS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Norspan-5h-Transderm-SE-BS-MPD)
* for[+] = Reference(Norspan-5h-Transderm-SE-BS-MID)
* for[+] = Reference(Norspan-5h-Transderm-SE-BS-APD)
