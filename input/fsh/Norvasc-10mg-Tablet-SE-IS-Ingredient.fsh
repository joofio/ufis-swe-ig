Instance: Norvasc-10mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Norvasc-10mg-Tablet-SE-IS-MPD)
* for[+] = Reference(Norvasc-10mg-Tablet-SE-IS-MID)
* for[+] = Reference(Norvasc-10mg-Tablet-SE-IS-APD)
