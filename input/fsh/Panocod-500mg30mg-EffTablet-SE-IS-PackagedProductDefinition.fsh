...
* packageFor = Reference(Panocod-500mg30mg-EffTablet-SE-IS-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Panocod-500mg30mg-EffTablet-SE-IS-MID)
