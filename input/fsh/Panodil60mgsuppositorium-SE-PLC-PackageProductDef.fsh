...
* packageFor = Reference(Panodil60mgsuppositorium-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Panodil60mgsuppositorium-SE-PLC-MID)
