Instance: Sandimmun50mgmlkoncentrat-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002164 "Ampoule"
* packageFor = Reference(Sandimmun50mgmlkoncentrat-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Sandimmun50mgmlkoncentrat-SE-PLC-MID)
