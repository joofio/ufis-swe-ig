Instance: Sendolor-1mgml-Solution-SE-BS-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002166 "Bag"
* packageFor = Reference(Sendolor-1mgml-Solution-SE-BS-MPD)
...
* packaging.packaging.packaging.containedItem.item.reference = Reference(Sendolor-1mgml-Solution-SE-BS-MID)
