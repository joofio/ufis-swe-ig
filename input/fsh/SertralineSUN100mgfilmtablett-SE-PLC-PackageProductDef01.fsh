Instance: SertralineSUN100mgfilmtablett-SE-PLC-PPD01
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(SertralineSUN100mgfilmtablett-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(SertralineSUN100mgfilmtablett-SE-PLC-MID)
