Instance: Stesolid-10mg-Solution-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Stesolid-10mg-Solution-SE-IS-MPD)
* for[+] = Reference(Stesolid-10mg-Solution-SE-IS-MID)
* for[+] = Reference(Stesolid-10mg-Solution-SE-IS-APD)
