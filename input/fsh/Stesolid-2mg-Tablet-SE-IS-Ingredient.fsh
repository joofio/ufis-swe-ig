Instance: Stesolid-2mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Stesolid-2mg-Tablet-SE-IS-MPD)
* for[+] = Reference(Stesolid-2mg-Tablet-SE-IS-MID)
* for[+] = Reference(Stesolid-2mg-Tablet-SE-IS-APD)
