Instance: Stesolid-5mg-Tablet-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Stesolid-5mg-Tablet-SE-IS-MPD)
* for[+] = Reference(Stesolid-5mg-Tablet-SE-IS-MID)
* for[+] = Reference(Stesolid-5mg-Tablet-SE-IS-APD)
