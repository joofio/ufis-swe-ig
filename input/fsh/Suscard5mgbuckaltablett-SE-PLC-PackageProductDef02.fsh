Instance: Suscard5mgbuckaltablett-SE-PLC-PPD02
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 90 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(Suscard5mgbuckaltablett-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Suscard5mgbuckaltablett-SE-PLC-MID)
