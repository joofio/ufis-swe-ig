Instance: Tegretol-100mg-Tablet-SE-AJ-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Tegretol-100mg-Tablet-SE-AJ-MPD)
* for[+] = Reference(Tegretol-100mg-Tablet-SE-AJ-MID)
* for[+] = Reference(Tegretol-100mg-Tablet-SE-AJ-APD)
