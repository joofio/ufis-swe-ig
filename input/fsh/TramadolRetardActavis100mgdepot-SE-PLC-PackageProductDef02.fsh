Instance: TramadolRetardActavis100mgdepot-SE-PLC-PPD02
...
* packaging.packaging.containedItem.item.reference = Reference(TramadolRetardActavis100mgdepot-SE-PLC-MID)
