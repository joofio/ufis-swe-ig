Instance: TramadolRetardHexal100mgdepot-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(TramadolRetardHexal100mgdepot-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(TramadolRetardHexal100mgdepot-SE-PLC-MID)
