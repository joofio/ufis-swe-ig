Instance: TrimonilR-200mg-PRTablet-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 200 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "tablet"
* packageFor = Reference(TrimonilR-200mg-PRTablet-SE-AJ-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(TrimonilR-200mg-PRTablet-SE-AJ-MID)
