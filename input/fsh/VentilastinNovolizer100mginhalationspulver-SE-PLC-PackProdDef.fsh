Instance: VentilastinNovolizer100mginhaspul-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002114 "Cartridge"
* packageFor = Reference(VentilastinNovolizer100mginhaspul-SE-PLC-MPD)
...
* packaging.containedItem.item.reference = Reference(VentilastinNovolizer100mginhaspul-SE-PLC-ManuItemDef)
