Instance: VoltarenT50mgFilmtablet-SE-PLC-PPD03
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 20 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(VoltarenT50mgFilmtablet-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(VoltarenT50mgFilmtablet-SE-PLC-MID)
