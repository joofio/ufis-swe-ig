Instance: Xylocain-WOP-10mgml-InjSol-SE-AJ-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Xylocain-WOP-10mgml-InjSol-SE-AJ-MPD)
* for[+] = Reference(Xylocain-WOP-10mgml-InjSol-SE-AJ-MID)
* for[+] = Reference(Xylocain-WOP-10mgml-InjSol-SE-AJ-APD)
