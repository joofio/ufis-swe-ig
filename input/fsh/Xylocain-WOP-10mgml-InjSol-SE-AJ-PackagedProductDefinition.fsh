Instance: Xylocain-WOP-10mgml-InjSol-SE-AJ-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 5 http://spor.ema.europa.eu/v1/lists/200000000014#200000002164 "Ampoule"
* packageFor = Reference(Xylocain-WOP-10mgml-InjSol-SE-AJ-MPD)
...
* packaging.packaging.packaging.containedItem.item.reference = Reference(Xylocain-WOP-10mgml-InjSol-SE-AJ-MID)
