Instance: Zinacef-750mg-Powder-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Zinacef-750mg-Powder-SE-IS-MPD)
* for[+] = Reference(Zinacef-750mg-Powder-SE-IS-MID)
* for[+] = Reference(Zinacef-750mg-Powder-SE-IS-APD)
