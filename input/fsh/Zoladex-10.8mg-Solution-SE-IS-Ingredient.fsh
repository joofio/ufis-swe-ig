Instance: Zoladex-10.8mg-Solution-SE-IS-ING
InstanceOf: PPLIngredient
Usage: #inline

* status = #active
* for[0] = Reference(Zoladex-10.8mg-Solution-SE-IS-MPD)
* for[+] = Reference(Zoladex-10.8mg-Solution-SE-IS-MID)
* for[+] = Reference(Zoladex-10.8mg-Solution-SE-IS-APD)
