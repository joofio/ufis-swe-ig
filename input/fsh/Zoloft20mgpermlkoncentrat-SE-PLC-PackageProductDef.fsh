Instance: Zoloft20mgpermlkoncentrat-SE-PLC-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #inline


* containedItemQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000002111 "Bottle"
* packageFor = Reference(Zoloft20mgpermlkoncentrat-SE-PLC-MPD)
...
* packaging.packaging.containedItem.item.reference = Reference(Zoloft20mgpermlkoncentrat-SE-PLC-MID)
